...
//removeItem(myGroceryList, 'chips') --> ['piz                            `za', 'hotpockets', 'MtnDew', 'corndogs'];
...
devMountainEmployees = [tyler, cahlan, ryan, colt] //Code Here

/*Now let's say Cahlan has a mental breakdown and has to take a leave of absence to 'find himself'.
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/

devMountainEmployees.splice(1, 1)  //Code Here
...
users.splice(0, 1)//Your Code Here
